...
public class LicenceTest {
    ...
    public void testEstValide() {               
        //On prend la date du jour pour d
        LocalDate d = LocalDate.now();       
        //Test licence valide 
        assertEquals(true, l2.estValide(d), "La licence doit etre valide" );
        //Test licence invalide 
        assertEquals(false, l1.estValide(d), "La licence doit être invalide");
